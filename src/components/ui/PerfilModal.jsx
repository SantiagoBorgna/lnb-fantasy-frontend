                ...
                {usuario?.rol === 'ADMIN' && (
                    <div className="pt-2 border-t border-border">
                        <button
                            ...
                            className="w-full py-3 rounded-xl font-semibold text-primary border border-primary/20 bg-primary/10 active:scale-95 transition-transform flex items-center justify-center gap-2"
                        >
