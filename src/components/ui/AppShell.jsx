    ...
    return (
        <div className="flex flex-col h-[100dvh] bg-background font-sans text-textMain overflow-hidden">
            ...
            <a
                ...
                className="fixed md:hidden bottom-[84px] right-4 bg-surface border border-border text-textMain p-3 rounded-full shadow-lg shadow-black/20 flex items-center gap-2 hover:bg-card hover:scale-105 active:scale-95 transition-all z-40 group"
