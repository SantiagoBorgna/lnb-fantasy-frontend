...
export default function ConfirmModal({ isOpen, onClose, onConfirm, titulo, mensaje }) {
        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col items-center text-center gap-3">
                    ...
                    <div>
                        <h2 className="text-textMain font-bold text-lg">{titulo || 'Confirmar acción'}</h2>
                ...
                <div className="flex gap-3 pt-2">
                    <button
                        type="button"
                        onClick={onClose}
                        className="flex-1 py-3.5 rounded-xl font-bold bg-surface border border-border text-textMain active:scale-95 transition-transform"
                    >
                        Cancelar
                    </button>
                    <button
                        type="button"
                        onClick={onConfirm}
                        className="flex-1 py-3.5 rounded-xl font-bold bg-red-500 text-white active:scale-95 transition-transform shadow-lg"
                    >
                        Confirmar
                    </button>
                </div>
